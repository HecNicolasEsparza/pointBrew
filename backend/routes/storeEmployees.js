...
// GET /store-employees/my-stores - Get stores where current user works as employee
router.get('/my-stores', authenticateToken, storeEmployeeController.getEmployeeStores);
